...
constexpr uint16_t console_font_7x9_first = 32; // index 0 = code 32 ""
constexpr uint16_t console_font_7x9_last = 126; // last index = code 126 "~"
#else
constexpr uint16_t console_font_7x9_first = 1; // index 0 = code 1 "☺︎"
constexpr uint16_t console_font_7x9_last = 254; // last index = code 254 "■"
#endif
